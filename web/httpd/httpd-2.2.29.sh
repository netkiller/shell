...
PREFIX_DIR=/srv
HTTPD_DIR=$HTTPD_DIR/httpd-2.2.29
...
wget http://apache.communilink.net//httpd/httpd-2.2.29.tar.bz2
...
ln -sv /srv/httpd-2.2.29 /srv/httpd
...
cp /srv/httpd-2.2.29/conf/extra/httpd-default.conf{,.original}
sed -i "s/ServerTokens Full/ServerTokens Prod/" /srv/httpd-2.2.29/conf/extra/httpd-default.conf
...
sed "2i#\n# chkconfig: 35 85 35" /srv/httpd-2.2.29/bin/apachectl > /etc/init.d/httpd
