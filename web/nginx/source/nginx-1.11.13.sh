...
--http-client-body-temp-path=/srv/nginx-1.11.13/var/cache/nginx/client_temp \
--http-proxy-temp-path=/srv/nginx-1.11.13/var/cache/nginx/proxy_temp \
--http-fastcgi-temp-path=/srv/nginx-1.11.13/var/cache/nginx/fastcgi_temp \
--http-uwsgi-temp-path=/srv/nginx-1.11.13/var/cache/nginx/uwsgi_temp \
--http-scgi-temp-path=/srv/nginx-1.11.13/var/cache/nginx/scgi_temp \
--user=nginx \
--group=nginx \
...
mkdir -p /srv/nginx-1.11.13/var/cache/nginx/client_temp
chown nginx:nginx -R /srv/nginx-1.11.13/var/cache/
