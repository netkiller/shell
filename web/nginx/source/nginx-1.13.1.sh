...
cd nginx-1.13.1
./configure --prefix=/srv/nginx-1.13.1 \
...
rm -f /srv/nginx
ln -s /srv/nginx-1.13.1 /srv/nginx

strip /srv/nginx-1.13.1/sbin/nginx

cp /srv/nginx-1.13.1/conf/nginx.conf{,.original}

vim /srv/nginx-1.13.1/conf/nginx.conf <<VIM > /dev/null 2>&1
