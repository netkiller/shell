...
export JAVA_OPTS="-server -Xms2048m -Xmx8192m -Djava.security.egd=file:/dev/./urandom"

#export CATALINA_HOME=/srv/apache-tomcat
#export LD_LIBRARY_PATH=/srv/apache-tomcat/lib
#export CATALINA_OPTS=" -Djava.awt.headless=true -Djava.library.path=$LD_LIBRARY_PATH"
