...
if [ -s php-7.0.0.tar.gz ]; then

tar jxf php-7.0.0.tar.bz2
cd php-7.0.0

./configure --prefix=/srv/php-7.0.0 \
--with-config-file-path=/srv/php-7.0.0/etc \
--with-config-file-scan-dir=/srv/php-7.0.0/etc/conf.d \
--enable-fpm \
--enable-opcache \
--with-fpm-user=www \
--with-fpm-group=www \
...
mkdir -p /srv/php-7.0.0/etc/conf.d
mkdir -p /srv/php-7.0.0/etc/fpm.d
cp /srv/php-7.0.0/etc/pear.conf{,.original}
cp php.ini-* /srv/php-7.0.0/etc/
cp /srv/php-7.0.0/etc/php.ini-production /srv/php-7.0.0/etc/php.ini
cp /srv/php-7.0.0/etc/php.ini-production /srv/php-7.0.0/etc/php-cli.ini
cp /srv/php-7.0.0/etc/php-fpm.conf.default /srv/php-7.0.0/etc/php-fpm.conf
cp /srv/php-7.0.0/etc/php-fpm.d/www.conf.default /srv/php-7.0.0/etc/php-fpm.d/www.conf
...
vim /srv/php-7.0.0/etc/php-fpm.conf <<end > /dev/null 2>&1
:17,17s/;pid/pid/
...
vim /srv/php-7.0.0/etc/php-fpm.d/www.conf <<end > /dev/null 2>&1
...
#:706,706s!;include_path = ".:/php/includes"!include_path = ".:/srv/php-7.0.0/lib/php:/srv/php-7.0.0/share"!
#:728,728s!; extension_dir = "./"!extension_dir = "./:/srv/php-7.0.0/lib/php/extensions:/srv/php-7.0.0/lib/php/extensions/no-debug-non-zts-20121212"!
