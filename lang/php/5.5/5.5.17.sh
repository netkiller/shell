...
if [ -s php-5.5.17.tar.bz2 ]; then
tar jxf php-5.5.17.tar.bz2
cd php-5.5.17

./configure --prefix=/srv/php-5.5.17 \
...
#:706,706s!;include_path = ".:/php/includes"!include_path = ".:/srv/php-5.5.17/lib/php:/srv/php-5.5.17/share"!
#:728,728s!; extension_dir = "./"!extension_dir = "./:/srv/php-5.5.17/lib/php/extensions:/srv/php-5.5.17/lib/php/extensions/no-debug-non-zts-20121212"!
