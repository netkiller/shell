...
cd /usr/local/src/
wget http://is1.php.net/distributions/php-5.5.12.tar.gz

if [ -s php-5.5.12.tar.gz ]; then
...
strip /srv/php-5.5.12/bin/php
strip /srv/php-5.5.12/bin/php-cgi
		
mkdir -p /srv/php-5.5.12/etc/conf.d
cp php.ini-* /srv/php-5.5.12/etc/
#cp /srv/php-5.5.12/etc/php.ini-development /srv/php-5.5.12/etc/php.ini
cp /srv/php-5.5.12/etc/php.ini-production /srv/php-5.5.12/etc/php.ini
cp /srv/php-5.5.12/etc/php-fpm.conf.default /srv/php-5.5.12/etc/php-fpm.conf
cp /srv/php-5.5.12/etc/pear.conf{,.original}
...
vim /srv/php-5.5.12/etc/php.ini <<EOF > /dev/null 2>&1
:299,299s$;open_basedir =$open_basedir = /www/:/tmp/:/var/tmp/:/srv/php-5.5.12/lib/php/:/srv/php-5.5.12/bin/$
...
#:706,706s!;include_path = ".:/php/includes"!include_path = ".:/srv/php-5.5.12/lib/php:/srv/php-5.5.12/share"!
#:728,728s!; extension_dir = "./"!extension_dir = "./:/srv/php-5.5.12/lib/php/extensions:/srv/php-5.5.12/lib/php/extensions/no-debug-non-zts-20121212"!
