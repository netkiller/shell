...
if [ ! -f v1.8.1.tar.gz ];then
	wget https://github.com/ethereum/go-ethereum/archive/v1.8.1.tar.gz
fi

if [ -s v1.8.1.tar.gz ]; then

tar zxvf v1.8.1.tar.gz
cd go-ethereum-1.8.1/
gmake all

mv build /srv/go-ethereum-1.8.1
...
ln -s /srv/go-ethereum-1.8.1 /srv/go-ethereum
