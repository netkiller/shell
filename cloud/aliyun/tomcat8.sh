...
curl -s https://raw.githubusercontent.com/oscm/shell/master/web/tomcat/profile.d.sh | bash
curl -s https://raw.githubusercontent.com/oscm/shell/master/web/tomcat/systemctl.sh | bash
curl -s https://raw.githubusercontent.com/oscm/shell/master/web/tomcat/firewall.sh  | bash
